...
/**
 * Ejercicio Practico 1 - Tipo A ¡OJO! Este código TIENE ERRORES que deben ser
 * subsanados a través de la depuración del código. Este programa es capaz
 * limpiar los elementos repetidos de un array de números enteros
 */
public class Ejercicio1 {

	public static void main(String[] args) {

		int[] array1 = new int[]{1, 1, 2, 2, 3, 4, 5, 5, 6, 6, 7, 7, 7, 8, 9, 9,
				10};
