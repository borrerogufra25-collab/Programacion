...
public class TemperaturasApp {
	...
	public static void main(String[] args) {
		...
		List<RegistroTemperatura> diasSuaves = obtenerDiasEntreTemperaturas(
				registros, 20.0, 25.0);
		System.out.println();
	...
	public static double calcularTemperaturaMedia(
	...
	public static RegistroTemperatura buscarDiaMasCaluroso(
			List<RegistroTemperatura> registros) {
		...
		for (int i = 1; i < registros.size(); i++) {
			...
			if (registroActual.getTemperatura() > diaMasCaluroso
					.getTemperatura()) {
	...
	public static int contarDiasPorEncimaDe(List<RegistroTemperatura> registros,
			double limite) {
		int contador = 0;
	...
	public static List<RegistroTemperatura> obtenerDiasEntreTemperaturas(
			List<RegistroTemperatura> registros, double temperaturaMinima,
